...
`define SR_USTIMER0  23
`define DR_USTIMER0  23
`define SR_MSTIMER0  24
`define DR_MSTIMER0  24
`define SR_IGN_PERIOD  25
`define DR_IGN_PERIOD  25
`define SR_IGN_CYCLE_CNT  26
`define DR_IGN_CYCLE_CNT  26
`define SR_PUFF1CNT  27
`define DR_PUFF1CNT  27
`define SR_PUFF1LEN  28
`define SR_SPI_DATA  29
`define DR_SPI_DATA  29
`define DR_CODE_WRITE_AD  30
`define SR_CODE_WRITE_DATA  31
`define DR_CODE_WRITE_DATA  31
`define SR_FDUART_DATA  32
`define DR_FDUART_DATA  32
`define SR_FDUART_STATUS  33
`define DR_FDUART_STATUS  33
`define SR_LEDS  34
`define DR_LEDS  34
