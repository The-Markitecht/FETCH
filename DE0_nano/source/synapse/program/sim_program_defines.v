...
`define SR_SPI_DATA  32
`define DR_SPI_DATA  32
`define SR_CODE_WRITE_ADDR  33
`define DR_CODE_WRITE_ADDR  33
`define SR_CODE_WRITE_DATA  34
`define DR_CODE_WRITE_DATA  34
`define SR_FDUART_DATA  35
`define DR_FDUART_DATA  35
`define SR_FDUART_STATUS  36
`define DR_FDUART_STATUS  36
`define SR_LEDS  37
`define DR_LEDS  37
