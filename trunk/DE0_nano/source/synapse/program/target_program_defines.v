...
`define SR_MSTIMER2  15
`define DR_MSTIMER2  15
`define SR_SPI_DATA  16
`define DR_SPI_DATA  16
`define SR_AV_WRITE_DATA  17
`define DR_AV_WRITE_DATA  17
`define SR_AV_READ_DATA  18
`define SR_AV_AD_HI  19
`define DR_AV_AD_HI  19
`define SR_AV_AD_LO  20
`define DR_AV_AD_LO  20
`define SDRAM_BASE  0
...
`define SR_FDUART_DATA  21
`define DR_FDUART_DATA  21
`define SR_FDUART_STATUS  22
`define DR_FDUART_STATUS  22
`define SR_LEDS  23
`define DR_LEDS  23
`define SR_BOARD_CTRL  24
`define DR_BOARD_CTRL  24
...
`define SR_ANMUX_CTRL  25
`define DR_ANMUX_CTRL  25
`define ANMUX_ENABLE_MASK  8
`define ANMUX_CHANNEL_MASK  7
`define SR_POWER_DUTY  26
`define DR_POWER_DUTY  26
`define SR_IGN_CAPTURE_JF  27
`define SR_IGN_TIMEOUT_LEN_JF  28
`define DR_IGN_TIMEOUT_LEN_JF  28
`define SR_PUFF_LEN_US  29
`define DR_PUFF_LEN_US  29
